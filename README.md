...
| `AUTOMARK_MODEL_NAME` | `phi4-mini:3.8b-q4_K_M` | Legacy alias for `AUTOMARK_ANALYSIS_MODEL_NAME` (deprecated; `AUTOMARK_ANALYSIS_MODEL_NAME` takes precedence when both are set) |
